...
class SubjectAltName(Base):
        ...
        @classmethod
        def normalise_uri(cls, uri):
            raise NotImplemented("We do not support URI type right now")

        @classmethod
        def normalise_email(cls, email):
            raise NotImplemented("We do not support email type right now")

        @classmethod
        def normalise_ip(cls, ip):
